...
Instala el sensor en cualquier servidor o VPS con un comando, y despliega tantos nodos como quieras — una red viva de sensores que laten hacia un mismo centro. Todos quedan visibles y gestionables desde el mismo dashboard, y la inteligencia se agrega automáticamente: cuantos más nodos, más señal.
...
![CipherSentry Dashboard — mapa de ataques en vivo (demo)](docs/threatmap.png)
